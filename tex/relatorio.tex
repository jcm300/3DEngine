...
Desta forma para calcular o vetor normal do ponto \texttt{A} tem que se ter em conta que o vetor $\overrightarrow{u}$ é o vetor que liga o vértice máximo do cone ao ponto em causa 
...
, para além do vetor $\overrightarrow{v}$, que pode basicamente ser calculado pelos valores das coordenadas x e y do ponto \texttt{P}, já que vetor $\overrightarrow{v}$ = P - O = (x, y, z) - (0, y, 0) = (x, 0, z).\\
