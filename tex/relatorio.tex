...
As texturas para o plano são calculadas de forma trivial dado as carateríticas deste modelo que tornam o cálculo das texturas imediato bastando, para isso, associar a cada vértice do plano um canto da textura:
...
\subsubsection{Texturas}
O cálculo das texturas para a caixa consistiu em aplicar a textura em causa a cada uma das faces deste modelo. Para cada uma das faces, visto tratar-se de um plano, aplicou-se a mesma lógica anteriomente descrita tendo, no entanto, em conta o facto de que uma caixa pode ser composta por diversas stacks e, como tal, cada face pode ser constituída por mais que quatro vértices. Sendo assim, a textura é mapeada nos vértices que constituam as stacks intermédias dividindo as coordenadas dos mesmos pelo comprimento da face permitindo assim obter o valor entre 0 e 1 caraterístico deste mapeamento.
...
Já no que diz respeito às faces laterais do cone, os valores das normais do pontos inseridos nestas fase são calculados tendo em conta:
...
Após este cálculo ser efetuado, basta obter o produto resultante de fazer \textit{cross} deste dois \textit{array's}.
