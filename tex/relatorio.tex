...
\end{description}
Portanto, com recurso ao mesmo (libxml2) obtemos do ficheiro XML e pela ordem apresentada no mesmo, os ficheiros em que cada um possui pontos referentes a um objeto tridimensional, sendo este ficheiros possíveis de ser gerados pelo generator atrás referido. 
